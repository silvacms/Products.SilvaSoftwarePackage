...
class VersionFieldTestCase(SilvaTestCase.SilvaTestCase):
    ...
    def test_get_releases(self):
        ...
        sr1 = self._add_and_publish_software_release(sp, '1.1', '1.1')
        sr2 = self._add_and_publish_software_release(sp, '1.1b1', '1.1b1')
        sr3 = self._add_and_publish_software_release(sp, '1.1rc1', '1.1rc1')
        sr4 = self._add_and_publish_software_release(sp, '1.1a1', '1.1a1')
        sr5 = self._add_and_publish_software_release(sp, '1.1b2', '1.1b2')
    ...
    def _add_and_publish_software_release(self, sp, id, version):
        sr = self._add_software_release(sp, id, version)
